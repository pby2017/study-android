package com.example.customchat.login;
...
import com.example.customchat.main.MainFragNavActivity;
...
import static com.example.customchat.constant.CustomConstant.LogConstant.CUS_ASYNC_TASK;
import static com.example.customchat.constant.CustomConstant.LogConstant.CUS_LOGIN_ACTIVITY;
...
public class RegisterAndLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initialize() {
        ...
        if (CustomConfig.getInstance().getEmail() != null) {
            ...
            Intent mainFragNavIntent = new Intent(this, MainFragNavActivity.class);
            startActivity(mainFragNavIntent);
        }
    }
